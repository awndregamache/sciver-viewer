...
<style>
  ...
  * {{ box-sizing:border-box; }}
  ...
  .source {{ background:#fff; border:1px solid var(--line); border-radius:10px;
             padding:14px 18px; margin:8px 0 14px; font-size:14px; color:#333; }}
  .source a {{ color:#1d6fb8; }}
  .muted {{ color:#888; }}
</style></head>
<body>
<header class="top">
...
<main>
  ...
  {body}
  <div class="source">
    <strong>Data source.</strong> All examples are from the <strong>SciVer</strong> dataset
    (Wang, Shen, Kuang, Cohan &amp; Zhao,
    <a href="https://aclanthology.org/2025.acl-long.420/">ACL 2025</a>;
    <a href="https://arxiv.org/abs/2506.15569">arXiv:2506.15569</a>),
    available on <a href="https://huggingface.co/datasets/chengyewang/SciVer">Hugging Face</a> under
    <a href="https://creativecommons.org/licenses/by/4.0/">CC BY 4.0</a>. This page is an unofficial
    viewer and is not affiliated with the dataset's authors.
  </div>
  <p class="muted" style="font-size:13px">Generated by <code>make_sciver_examples.py</code> from
     <code>testset.json</code>.</p>
</main>
</body></html>"""
